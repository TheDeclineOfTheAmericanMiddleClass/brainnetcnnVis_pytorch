...
# 8 continuous prediction domain personality outcomes (OCEAN separately, each non-spurious soft-clusters)
# 1 multiclass (hardcluster)

datasets=('rest1' 'working_memory' 'gambling' 'motor' 'rest2' 'language' 'social' 'relational' 'faces')
outcomes=('NEOFAC_O' 'NEOFAC_C' 'NEOFAC_E' 'NEOFAC_A' 'NEOFAC_N', 'hardcluster') # TODO: ns soft
models=('BNCNN' 'SVM')
